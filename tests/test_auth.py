...
class TestAuthConfig:
    ...
    def test_auth_disabled_by_default(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            from k8s_mcp.server.auth.config import get_auth_config
...
class TestMCPScopes:
    ...
    def test_all_scopes_returns_list(self):
        ...
        from k8s_mcp.server.auth.scopes import MCPScopes
...
class TestToolScopes:
    ...
    def test_get_required_scopes_read_tool(self):
        ...
        from k8s_mcp.server.auth.scopes import get_required_scopes, MCPScopes
    ...
    def test_has_required_scopes_with_tools_scope(self):
        ...
        from k8s_mcp.server.auth.scopes import has_required_scopes, MCPScopes
