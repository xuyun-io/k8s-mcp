...
- **Changes**: Added `k8s-mcp-apps/` - interactive MCP Apps dashboards for Kubernetes management
...
- **NEW**: `k8s-mcp-apps/` React/Vite MCP Apps collection

### Release v1.22.0 Changes

#### k8s-mcp-apps (MCP Apps Collection)
Added in-repository MCP Apps UI collection for interactive Kubernetes dashboards using MCP ext-apps SDK.
